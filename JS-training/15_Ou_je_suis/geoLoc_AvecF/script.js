    ...
    add.addEventListener("click", function () {
        ...
        navigator.geolocation.getCurrentPosition(function (position) {
            ...
            save.addEventListener("click",
                function () {
                    let latitude = typeof 'number'
                    let longitude = typeof 'number'
...
function getSaveFunction(getSave) {
    // CREATION D'UN EVENT SUR LE BOUTON GET SAVE POUR RETROUVER MA POSITION SAUVEGARDE
    getSave.addEventListener("click", function () {
        ...
        //   SI LSlatitude et LSlongitude existe (S'il y a bien des données dans le LocalStorage)
